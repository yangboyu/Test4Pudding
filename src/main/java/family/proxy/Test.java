...
import family.TestInvokeHandler;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        BusinessProcessor bp = (BusinessProcessor) Proxy.newProxyInstance(BusinessProcessor.class.getClassLoader(), new Class[] { BusinessProcessor.class }, new BusinessProcessorHandler(bpimpl));
//        TestInvokeHandler handler = new TestInvokeHandler(bpimpl);
